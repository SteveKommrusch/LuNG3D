 ...
 * Experimental editting by: Steve Kommrusch <steveko@colostate.edu>
 *
 */
/**
...
fprintf(stdout, "SJKDEBUG:    xyzspace={ %f, %f, %f }, xc=%d, yc=%d, zc=%d\n",
          xyzSpace[0],xyzSpace[1],xyzSpace[2], xc, yc, zc);
...
fprintf(stdout, "SJKDEBUG:    nbcomp=%d, comp_sz[0]=%d, comp_sz[1]=%d\n", nbcomp, comp_sz[0], comp_sz[1]);
